...
function initBookClose(overlay, bookLeft, bookRight, bookSpine, elements) {
  setTimeout(function () {
    bookLeft === null || bookLeft === void 0
      ? void 0
      : bookLeft.classList.add("closing");
    bookRight === null || bookRight === void 0
      ? void 0
      : bookRight.classList.add("closing");
    setTimeout(function () {
...
function runPageTurnExit(href) {
  ...
  var snapshot = Array.from(document.body.children).filter(function (c) {
    return c !== behind;
  });
...
function initToggleTab(tabId, targetSelector) {
  ...
  (_a = tab.parentNode) === null || _a === void 0
    ? void 0
    : _a.replaceChild(newTab, tab);
...
function initRolling() {
  ...
  function fireRoll(name, modifier) {
    ...
    var modStr =
      modifier > 0
        ? '<span class="roll-op">+</span><span class="roll-mod">'.concat(
            modifier,
            "</span>",
          )
        : modifier < 0
  ...
  if (statsSheet) {
    statsSheet.querySelectorAll("dl > div").forEach(function (div) {
      ...
      div.addEventListener("click", function () {
        ...
        fireRoll(
          (_b =
            (_a = dt.textContent) === null || _a === void 0
              ? void 0
          ...
          parseInt(
            (_d =
              (_c = dd.textContent) === null || _c === void 0
                ? void 0
    ...
    defSection.querySelectorAll("dl > div").forEach(function (div) {
      ...
      div.addEventListener("click", function () {
        ...
        return fireRoll(
          ...
          parseInt(
            (_b =
              (_a = dd.textContent) === null || _a === void 0
                ? void 0
                : _a.trim()) !== null && _b !== void 0
              ? _b
              : "0",
...
function initHeroPoints() {
  ...
  icons.forEach(function (icon, index) {
    ...
    (_a = icon.parentNode) === null || _a === void 0
      ? void 0
      : _a.replaceChild(newIcon, icon);
    function toggle() {
...
function expandCalEvents(rawEvents, rangeStart, rangeEnd) {
  ...
  for (var _i = 0, rawEvents_1 = rawEvents; _i < rawEvents_1.length; _i++) {
    ...
    if (raw["RRULE"]) {
      results.push.apply(
        results,
        expandRRule(raw, start, duration, rangeStart, rangeEnd),
      );
...
function expandRRule(raw, dtStart, duration, rangeStart, rangeEnd) {
  ...
  var byDay = rules["BYDAY"]
    ? rules["BYDAY"].split(",").map(function (d) {
        return CAL_DAY_MAP[d.replace(/[+\-\d]/g, "")] || 0;
      })
    : null;
  var results = [];
  var count = 0;
  ...
  if (freq === "WEEKLY" && byDay) {
    ...
    while (cursor <= rangeEnd && count < maxCount) {
      for (
        var _i = 0,
          _a = __spreadArray([], byDay, true).sort(function (a, b) {
            return a - b;
          });
        _i < _a.length;
        _i++
...
function renderCalendar() {
  ...
  calEvents
    .filter(function (ev) {
      return ev._start >= mStart && ev._start <= mEnd;
    })
    .forEach(function (ev) {
  ...
  for (var d = 1; d <= daysInMonth; d++) {
    ...
    htmlParts.push(
      '<div class="'
        .concat(cls, '"><span class="cal-day-num">')
        .concat(d, "</span>"),
    );
    if (evs.length) {
      ...
      evs.slice(0, 2).forEach(function (ev) {
        ...
        htmlParts.push(
          '<div class="cal-event-pill" title="'
            .concat(name, '"><span class="cal-event-name">')
            .concat(name, "</span></div>"),
        );
      });
      if (evs.length > 2)
        htmlParts.push(
          '<div class="cal-event-more">+'.concat(evs.length - 2, " more</div>"),
        );
      htmlParts.push("</div>");
    }
    htmlParts.push("</div>");
...
function renderUpcoming() {
  ...
  if (!container) return;
  var now = new Date();
  var future = calEvents
    .filter(function (ev) {
      return ev._start >= now;
    })
    .slice(0, 8);
  if (!future.length) {
    container.innerHTML =
      '<p class="cal-empty">No upcoming streams scheduled \u2014 check back soon!</p>';
    return;
  }
  var htmlParts = [];
  htmlParts.push(
  ...
  future.forEach(function (ev) {
    ...
    htmlParts.push(
      '<div class="upcoming-event">\n      <div class="upcoming-date-block">\n        <span class="upcoming-weekday">'
        .concat(
          ev._start.toLocaleDateString([], { weekday: "short" }),
        ...
        .concat(
          ev._start.toLocaleDateString([], { month: "short" }),
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!grid) return [2 /*return*/];
          grid.innerHTML =
            '<div class="cal-loading">Consulting the stars\u2026</div>';
        ...
        case 5:
          ...
          grid.innerHTML =
            '<div class="cal-error">The stars are silent. (Could not load schedule)</div>';
          return [3 /*break*/, 6];
        case 6:
          _i++;
          return [3 /*break*/, 1];
        case 7:
          ...
          grid.innerHTML =
            '<div class="cal-error">Could not load the schedule. Please try again later.</div>';
          return [2 /*return*/];
      }
    });
  });
...
function initCalendar() {
  ...
  (_a = document.getElementById("cal-prev")) === null || _a === void 0
    ? void 0
  ...
  (_b = document.getElementById("cal-next")) === null || _b === void 0
    ? void 0
